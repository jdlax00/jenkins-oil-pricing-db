...
def parse_musket_file(file):
    ...
    for line in lines:
        ...
        if start_processing and line and not line.startswith('--') and not line.startswith('MSK1'):
            # Parse data lines
...
class MusketStaging:
    ...
    def process_musket_files(self):
        start_time = time.time()
        blob_manager = BlobStorageManager("jenkins-pricing-historical", "musket")
...
if __name__ == "__main__":
    staging = MusketStaging()
    final_df = staging.process_musket_files()
